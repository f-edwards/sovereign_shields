---
title: "Sovereign Shields: Law Enforcement, Child Protection, and State Violence in Indian Country"
...
abstract:
  "Sovereign nations are charged with leveraging their legal status and resources to protect citizens from external threats. In this paper, we suggest that American Indian nations leverage their sovereignty to 'shield' American Indians from violence at the hands of settler colonial state actors. We broadly consider the scale and distribution of the exposure of American Indians to state violence at the hands of federal, state, and local actors with a focus on the criminal - legal system and the child welfare system. We suggest that American Indians' exposure to police violence, arrest, and incarceration is tightly correlated with American Indians' exposure to family separation through the child welfare system, and that these co-occurring forms of violence are intimately tied to histories and ongoing processes of disposession and genocide. Formally, we show that spatial and temporal variation in Native risk of exposure to settler colonial state violence is a function of federal Indian law, tribal sovereignty, and structural disadvantage. We use data from Fatal Encounters, the Census of Tribal Justice Agencies, the Census of Jails, the Annual Survey of Jails, the Uniform Crime Reports, the American Community Survey, the Adoption and Foster Care Analysis and Reporting System, and the National Child Abuse and Neglect Data System to estimate how risk varies across these geographies as a function of the status and strength of tribal sovereigns. "
---
...
Between 2000 and 2018, Fatal Encounters recorded 209 police-involved non-suicide deaths of American Indians and Alaska Natives in the lower 48 states of the US. We show the distribution of these killings across states and tribal lands in Figure F1. Of these, 87 (42 percent) occurred on tribal lands. A large remainder of the deaths recorded in FE occurred near tribal land, or in cities with large populations of American Indians. Future analyses will identify deaths occurring at the interstices of US and tribal land and deaths occurring in cities that were host to large numbers of American Indians during the termination era. 

![Figure F1: Police killings of American Indians and Alaska Natives. Blue indicates tribal homeland. Dot indicates AIAN person killed by police, 2000 - 2018](./vis/map_fe_aian.png)
...
Figure F5 shows the estimated relationship between the extent of tribal jurisdiction over non-Indians and rates of police-involved deaths for each class of PL-280 states. Rates are higher in mandatory and optional PL-280 states than in non-PL280 states. On lands where tribal governments have broad jurisdiction and do not have to defer to state and local law enforcement for policing on tribal lands rates of police-involved killings are much lower. 

![Figure F5: Predicted AIAN deaths per 100,000 persons per year](./vis/model_fe.png)

## Discussion and Conclusion

While the colonial legacy of anti-Indian violence is likely the key force driving these killings, we suggest that tribal sovereignty is operating as a “sovereign shield” against police violence. That is, tribes may indeed be using their sovereignty as a shield to protect their community members from coercion at the hands of local, state, and federal government agencies. Sovereignty provides a nation with exclusive jurisdiction over a defined area of land, people, and resources, upon which a sovereign can promote the health, safety, and well-being of its peoples. Efforts to protect members from violence from external actors are consistent 

However, tribes are likely to seek to shield their members not only from police violence, but also from a broader set of violent intrusions from state, local, and federal agents. In future work, we will consider whether and how sovereignty impacts other forms of criminal justice involvement, such as arrest and incarceration, and non-criminal justice outcomes that are nonetheless disruptive and violent, such as family separations through the child welfare system.
...
Friends of the Indians in the Assimilationist Era. 
